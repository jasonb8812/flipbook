...
return name+": "+style.getPropertyValue(name)+(style.getPropertyPriority(name)?" !important":"")}return util!function(modules) {
    ...
    var _libs = __webpack_require__(0)
      ...
      , MathUtils = function(_BaseMathUtils) {
        ...
        MathUtils.getLinearIndeces = function(spline, n) {
            ...
            _d += ls[_i])
                Math.abs(L - _d) < Math.abs(L - _d - ls[_i + 1]) && (res.push(_i * dDel),
                L += dl);
            return res
        }
        ,
      ...
      , SheetBlock = function() {
        ...
        SheetBlock.prototype.set = function(angle) {
            ...
            var closedAngle = void 0
              , binderTurn = void 0;
            "object" === ("undefined" == typeof angle ? "undefined" : _typeof(angle)) ? (this.angle = angle.openedAngle,
    ...
    var _extends = Object.assign || function(target) {
      ...
      , Finder = function() {
        function Finder(strs, pattern, props) {
            ...
            for (var p = 0; ; ) {
                if (p = this.lstr.indexOf(this.pattern, p),
                p === -1)
                    break;
                this.addHits(p),
                this.addContext(p),
...
, function(module, exports, __webpack_require__) {
    ...
    _libs.PDFJS.workerSrc = (window.PDFJS_LOCALE ? PDFJS_LOCALE : {
        pdfJsWorker: "jhttps://cdn.jsdelivr.net/npm/3d-flip-book@1.9.9/js/pdf.worker.js",
        pdfJsCMapUrl: "cmaps/"
    }).pdfJsWorker,
    _libs.PDFJS.cMapUrl = (window.PDFJS_LOCALE ? PDFJS_LOCALE : {
        pdfJsWorker: "https://cdn.jsdelivr.net/npm/3d-flip-book@1.9.9/js/pdf.worker.js",
        pdfJsCMapUrl: "cmaps/"
    }).pdfJsCMapUrl,
...
, function(module, exports, __webpack_require__) {
    ...
    _libs.$.fn.FlipBook = function(options) {
        ...
        scene.view = new _BookView2.default(this.length ? this[0] : (0,
        _libs.$)("<div>").appendTo("body"),function() {
            ...
            ,
            options.pdf ? (scene.propsBuilder = new _PdfBookPropsBuilder2.default(options.pdf,scene.bookBuilder),
            scene.propsBuilder.pdf.setLoadingProgressClb(scene.loadingCtrl.setProgress.bind(scene.loadingCtrl))) : options.pageCallback ? scene.propsBuilder = new _ClbBookPropsBuilder2.default(scene.visual,options.pageCallback,options.pages,scene.bookBuilder) : scene.propsBuilder = new _ClbBookPropsBuilder2.default(scene.visual,_Book2.default.pageCallback,6,scene.bookBuilder)) : _Detector2.default.addGetWebGLMessage({
      ...
      , Book = function(_THREE$EventDispatche) {
        ...
        Book.prototype.getPage = function() {
            ...
            if (this.angle === PI / 2 || this.angle === 3 * PI / 2) {
                ...
                this.angle < PI / 2 ? p = 0 : this.angle > 3 * PI / 2 ? p = 1 : this.angle < PI ? p = this.getPages() - 3 : this.angle >= PI && (p = this.getPages() - 1);
            return p
        }
        ,
        ...
        Book.prototype.flipLeft = function() {
            ...
            return this.sheetPhysics.getSize() < 25 && !function() {
                ...
                }, progressClb) : left && "closed" === left.state && left.angle > PI / 2 ? (block = size < left.getSize() ? _this2.splitSheetBlock(0, left.getSize() - size)[1] : left,
        ...
        Book.prototype.flipRight = function() {
            ...
            return this.sheetPhysics.getSize() < 25 && !function() {
                ...
                }, progressClb) : right && "closed" === right.state && right.angle <= PI / 2 ? (block = size < right.getSize() ? _this3.splitSheetBlock(_this3.sheetBlocks.length - 1, size)[0] : right,
        ...
        Book.prototype.cornerCallback = function(e, data) {
            ...
            this.mouseController && !function() {
                var _data$data = data.data
                  ...
                  , n = _data$data.n;
                if ("mouseover" === e.type)
                    _this4.hoverInfo && void 0 !== _this4.hoverInfo.pendings ? ++_this4.hoverInfo.pendings : (_this4.hoverInfo && (console.warn("Wrong state: element is already hover"),
                    _this4.hoverInfo.n !== n && _this4.clearHoverInfo()),
                    _this4.hoverInfo || _this4.dragInfo || !function() {
                    ...
                    void 0 !== _this4.hoverInfo.pendings ? --_this4.hoverInfo.pendings : n === _this4.hoverInfo.n && _this4.clearHoverInfo();
        ...
        Book.prototype.notifyAfterAnimation = function() {
            this.animationNotification && (delete this.animationNotification,
        ...
        Book.createSideTexture = function(color) {
            var jC = (0,
            _libs.$)('<canvas width="8" height="8"></canvas>')
        ...
        Book.prepareProps = function(props) {
            return Book.calcProps(Book.mergeProps((0,
            _book.props)(), props))
        }
        ,
      ...
      , BookController = function(_Controller) {
        function BookController(book, view, props) {
            ...
            _this.bookWatcher = new _Object3DWatcher2.default(_this.visual,function() {
                return _this.state.singlePage ? _this.state.activeSide ? _this.boxs[0].setFromObject(book.rightCover.three) : _this.boxs[0].setFromObject(book.leftCover.three) : (_this.boxs[0].setFromObject(book.leftCover.three),
        ...
        BookController.prototype.cmdBackward = function() {
            var _this4 = this;
            this.state.singlePage ? (this.state.activeSide = (this.getPage() + 1) % 2,
        ...
        BookController.prototype.goToPage = function(page) {
            ...
            if (target != current) {
                ...
                current += 1,
                ++covs) : current === this.book.getPages() - 1 && (flips.push(-1),
                current -= 2,
                ++covs);
                var cv = 0;
                0 === target ? (cv = -1,
                target += 1,
                ++covs) : target === this.book.getPages() - 1 && (cv = 1,
                target -= 2,
                ++covs),
        ...
        BookController.prototype.getActions = function() {
            ...
            return _extends({}, cmds, {
                ...
                touchCmdRotate: {
                    activate: function(e, data) {
                        isSwipping("touchCmdRotate") || (e.preventDefault(),
                        _this8.orbit.actions.rotate(e, data))
                    }
                },
                touchCmdZoom: {
                    activate: function(e, data) {
                        isSwipping("touchCmdZoom") || (e.preventDefault(),
                        data.dy > 0 ? _this8.cmdZoomOut() : data.dy < 0 && _this8.cmdZoomIn())
                    }
                },
                touchCmdPan: {
                    activate: function(e, data) {
                        isSwipping("touchCmdPan") || (e.preventDefault(),
                    ...
                    activate: function(e, data) {
                        if (isSwipping("touchCmdSwipe"))
                            ...
                            "start" === data.state) {
                                ...
                                "move" === data.state ? _this8.swipeData.handled || (_this8.swipeData = _extends({}, _this8.swipeData, {
    ...
    var _libs = __webpack_require__(1)
      , BookPrinter = function() {
        ...
        BookPrinter.prototype.print = function() {
            ...
            "pdf" === this.type ? !function() {
                var printWnd = void 0
                  , callManually = !1;
                _this.useIFrame() ? (callManually = !!_this.frame,
                _this.frame || (_this.frame = (0,
                _libs.$)('<iframe src="' + _this.pdfSrc + '" style="display: none;"></iframe>').appendTo(_this.doc.body)),
                printWnd = _this.frame[0].contentWindow) : printWnd = _this.wnd.open(_this.pdfSrc),
    ...
    var _extends = Object.assign || function(target) {
      ...
      , PageManager = function() {
        ...
        PageManager.prototype.pushInRenderQueue = function(o) {
            "queuedForRender" !== o.state && (o.state = "queuedForRender",
        ...
        PageManager.prototype.updateRenderQueue = function() {
            if (this.canvas) {
                ...
                if (!this.rendering && (p.renderWhileFlipping || !this.book.isProcessing())) {
                    ...
                    this.rendering && (this.rendering.wrapper.startRender ? (this.removeFromRenderQueue(this.rendering),
                    this.rendering.state = "rendering",
                    this.rendering.wrapper.setResolution(this.calcResolution(this.rendering)),
                    this.rendering.wrapper.startRender()) : delete this.rendering)
                }
                setTimeout(this.updateRenderQueue.bind(this), 250)
            }
        }
                ...
                togle: function(e) {
                    ...
                    if (li.hasClass("item")) {
                        ...
                        if (cmd.hasClass("cmd")) {
                            ...
                            li.append((_this.renderNode(node).match(/<ul.*<\/ul>/) || [""])[0]))) : _this.onNavigate && _this.onNavigate(node.item)
                        }
                    }
                }
            },
    ...
    var _libs = __webpack_require__(0)
      ...
      , LoadingAnimation = function() {
        function LoadingAnimation(width, height, color) {
            ...
            var jC = (0,
            _libs.$)('<canvas width="' + width + '" height="' + height + '"></canvas>');
            this.c = jC[0],
            this.p = {
                g: 9.8,
                dt: 1 / 60,
        ...
        LoadingAnimation.prototype.update = function(T) {
            ...
            this.t >= this.p.updateInterval) {
                ...
                for (var i = 0, _a = a, _r = .2 * r; i < ps; ++i,
                _r *= .9,
                _a += da) {
                    ctx.beginPath(),
                    ctx.fillStyle = _GraphUtils2.default.color2Rgba(_GraphUtils2.default.inverseColor(this.p.color, (ps - i) / ps), .7 * (ps - i) / ps);
        ...
        LoadingAnimation.prototype.createSprite = function(n) {
            var c = (0,
            _libs.$)('<canvas width="' + this.c.width * n + '" height="' + this.c.height + '"></canvas>')[0]
              , ctx = c.getContext("2d")
    ...
    var _extends = Object.assign || function(target) {
      ...
      , Object3DWatcher = function() {
        ...
        Object3DWatcher.prototype.centerView = function(T) {
            ...
            var dv = this.dv;
            if (K > 1 - this.eps ? dv.set(-box.mid.x, -box.mid.y) : dv.set(this.computeCorr(Kx, box.min.x, box.max.x), this.computeCorr(Ky, box.min.y, box.max.y)),
            Math.sqrt(this.os.vx * this.os.vx + this.os.vy * this.os.vy) > .003 || dv.length() > .003) {
                var dt = 1 / 60
                  , t = 0
                  , os = _extends({}, this.os, {
                    x: 0,
        ...
        function Orbit(object, domElement) {
            ...
            _this.update = function() {
                ...
                return function() {
                    ...
                    scope.enableDamping === !0 ? (sphericalDelta.theta *= 1 - scope.dampingFactor,
    ...
    var _libs = __webpack_require__(0)
      ...
      , PdfImage = function(_ImageBase) {
        ...
        PdfImage.prototype.calcViewport = function() {
            ...
            (!this.viewport || Math.abs(this.viewport.scale - scale) > 1e-4) && (this.viewport = this.page.getViewport(scale),
    ...
    var _extends = Object.assign || function(target) {
      ...
      , View = function() {
        function View(parentContainer, onLoad) {
            ...
            this.isIOS && ((0,
            _libs.$)(this.parentContainer[0].ownerDocument.defaultView).on("resize", this.binds.onResize),
            this.onResize(),
            setTimeout(this.checkIframeSize.bind(this), 250)),
            this.container = (0,
            _libs.$)(this.frame.contentDocument.body),
            this.container.css("margin", "0"),
            this.head = (0,
            _libs.$)(this.frame.contentDocument.head),
            this.onLoad = onLoad,
            this.handlers = [];
 ...
 */
    !function(factory) {
        ...
        function handler(event) {
            ...
            "axis"in orgEvent && orgEvent.axis === orgEvent.HORIZONTAL_AXIS && (deltaX = deltaY * -1,
            deltaY = 0),
            delta = 0 === deltaY ? deltaX : deltaY,
            "deltaY"in orgEvent && (deltaY = orgEvent.deltaY * -1,
            delta = deltaY),
